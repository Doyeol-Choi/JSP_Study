...
ALTER TABLE tbl_member_202005 ADD FOREIGN KEY(p_code) REFERENCES tbl_party_202005;

ALTER TABLE tbl_vote_202005 ADD FOREIGN KEY(m_no) REFERENCES tbl_member_202005;